    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 p-0 opacity-50 hover:opacity-100 rounded-full",
        ),
        nav_button_previous: "absolute left-1",
        nav_button_next: "absolute right-1",
        table: "w-full border-collapse",
        head_row: "flex",
        head_cell: "text-muted-foreground/60 w-9 font-medium text-[0.72rem] text-center uppercase tracking-wider",
        ...
        day_today: "font-bold text-primary ring-1 ring-primary/40 rounded-full",
        day_outside:
          "day-outside text-muted-foreground opacity-30 aria-selected:bg-transparent aria-selected:text-muted-foreground aria-selected:opacity-20",
